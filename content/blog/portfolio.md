...
# 기획
포트폴리오 페이지가 필요하기도 했고, 마침 '멋쟁이 사자처럼 대학' IT 연합동아리에서 1주차 과제가 포트폴리오 페이지 작성이었기 때문에 며칠간 계속해서 작업했다. 군생활 때 만들었던 포트폴리오 페이지의 아이디어를 다시 떠올려 사용했다.
...
![portfolioGif](https://github.com/user-attachments/assets/9cf34b76-7469-49ec-ba19-e5f510958b58)
...
딱히 큰 특징은 없는 페이지이다.
나에 대해 조금 더 자세히 작성해놓은 페이지이다.

> ![about](https://github.com/user-attachments/assets/0021c79f-63a3-49b6-aad7-f4da92c832e4)

## Timeline 섹션
포트폴리오 페이지의 메인이라고 볼 수 있다.
위에서 말했던 음악 플레이어 UI가 사용된 섹션이다.

> ![timeline](https://github.com/user-attachments/assets/03b5905d-ea20-4dd4-a8f4-e63dc0b4c6b3)
...
다시 초심으로 돌아간 듯한 기분도 느껴졌다.
군복무 중 야간 사지방 연등 때 구글링하며 만들던 포트폴리오 페이지가 어렴풋이 떠오르는 프로젝트였다.